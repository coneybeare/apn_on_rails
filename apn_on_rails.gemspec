...
easily add Apple Push Notification (iPhone) support to your Rails application.
  ...
  s.files = [
    ...
    "lib/generators/apn_on_rails/migrations_generator.rb",
    "lib/generators/apn_on_rails/USAGE",    
    "lib/generators/apn_on_rails/templates/migrations/create_apn_devices.rb",
    "lib/generators/apn_on_rails/templates/migrations/create_apn_notifications.rb",
    "lib/generators/apn_on_rails/templates/migrations/alter_apn_devices.rb",
    "lib/generators/apn_on_rails/templates/migrations/create_apn_apps.rb",
    "lib/generators/apn_on_rails/templates/migrations/create_groups.rb",
    "lib/generators/apn_on_rails/templates/migrations/alter_apn_groups.rb",
    "lib/generators/apn_on_rails/templates/migrations/create_device_groups.rb",
    "lib/generators/apn_on_rails/templates/migrations/create_apn_group_notifications.rb",
    "lib/generators/apn_on_rails/templates/migrations/create_pull_notifications.rb",
    "lib/generators/apn_on_rails/templates/migrations/alter_apn_notifications.rb",
    "lib/generators/apn_on_rails/templates/migrations/make_device_token_index_nonunique.rb",
    "lib/generators/apn_on_rails/templates/migrations/add_launch_notification_to_apn_pull_notifications.rb",
    "lib/apn_on_rails.rb",
